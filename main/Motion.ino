...
void Move()
{
  ...
  uint16_t zi = (data[5] << 8) | data[4];
   Ax = *(int16_t*)(&xi) / SensorMaximumReading* SensorMaximumAccel;
   Ay = *(int16_t*)(&yi) / SensorMaximumReading* SensorMaximumAccel;
//   Az = *(int16_t*)(&zi) / SensorMaximumReading* SensorMaximumAccel;
